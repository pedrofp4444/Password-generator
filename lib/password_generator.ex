defmodule PasswordGenerator do
  @moduledoc """
  `PasswordGenerator` intends to generate a random password depending on parameters, where Module main function is `generate(options)`.
  ...
  defp validate_length(true, _options), do: {:error, "Please provide a length"}

  defp validate_length(false, options) do
